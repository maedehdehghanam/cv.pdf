...
\vspace{4pt}
\item{\cventry{Sep. 2014 to Jun. 2020}{Diploma in Mathematics and Physics}{Farzanegan1 High School}{Shiraz, Iran}{}{\vspace{3pt} 
\begin{itemize}
...
\small{
    \begin{tabular}
        ...
        \vspace{6pt}
        ~~~\textbf{\large Compiler Design} & \textbf{\large Computer Architecture} & \textbf{\large Operating Systems } \\
        ~~~~\textbf{\large Cloud Computing} &  \textbf{\large Distributed Systems} &
        \textbf{\large High Performance Computing}
    \end{tabular}
    \medskip
    %\end{adjustwidth}
} % sm
...
\begin{itemize}
\vspace{4pt}
\item{\cventry{}{Ongoing Research under supervision of  \textbf{\href{https://sharif.edu/~azad/}{\textcolor{blue}{Prof. Sarbazi-Azad.}}}}{Benchmark suite for GPUs}{}{}{
\begin{itemize}
\item Creating a modern benchmark for GPUs consisting of current GPU workloads, implemented in a maintainable and extendable manner, Including modern neural network architectures, graph algorithms, and typical GPU applications.
\end{itemize}
}}
\end{itemize}
 %=======
...
\item{\cventry{Jun. 2023 to Present}{\href{https://www.ipm.ac.ir/}{Institute For Research In Fundamental Sciences (High Performance Computing Center)}}{Platform Engineer}{Tehran, Iran}{}{ 
\begin{itemize}
\item{Optimized parallel computing applications for high-performance clusters, significantly enhancing computational efficiency and tackling complex challenges.}
...
\item The system consists of two modules. One module has the task of communicating with the user, and the other module has the task of generating waveforms. These two parts are connected to each other using SPI protocol.
\end{itemize}
}}
