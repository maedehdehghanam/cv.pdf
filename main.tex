...
\name{Maedeh}{Dehghan} 
\address{
University of Alberta, Edmonton, Canada}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
     % optional, remove / comment the line if not wanted
%phone[fixed]{01234 123456}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{maedeh3@ualberta.ca}    
\phone[mobile]{+1 587 921 7910} 
% optional, remove / comment the line if not wanted
\homepage{maedehdehghanam.github.io}                         % optional, remove / comment the line if not wanted
\extrainfo{\github{
...
\item{\cventry{Sep. 2024 to Sep. 2026 [Expected]}{Master of Science in Computer Science}{\href{https://www.ualberta.ca/en/index.html}{University of Alberta} }{Edmonton, Canada}{
}{ 
\begin{itemize}
\item{GPA: 3.8/4}
\end{itemize}
...
\item{\cventry{Sep. 2020 to Jun. 2024}{Bachelor of Science in Computer Engineering}{\href{https://www.sbu.ac.ir/web/cse}{Shahid Beheshti University} }{Tehran, Iran}{}{\vspace{3pt} 
\begin{itemize}
\item {GPA: 3.8/4}
\end{itemize}
}}
...
\small{
    \begin{tabular}
        ...
        ~~~~~~Compiler Design  & Advanced Computer Architecture & Microprocessor \& Assembly Languages \\ 
        ~~~~~~Operating Systems & Natural Language Processing & Neurosymbolic Programming\\
    \end{tabular}
    \medskip
    %\end{adjustwidth}
} % sm
...
\item{\cventry{Oct. 2025 to Present}{{Amii (Alberta Machine Intelligence Institute)}}{Technical Advisement | Part-time}{Edmonton, Canada}{}{ 
\begin{itemize}
\item{Contributing to brainstorming ML approaches for solving the client’s business problem.}
\item{Conducting academic and/or industrial literature reviews to determine ML approaches for solving the client’s business problem.}
\end{itemize}
}}


\item{\cventry{Oct. 2023 to Jun. 2024}{{Institute For Research In Fundamental Sciences (High-Performance Computing Center)}}{Platform Engineer | Part-time}{Tehran, Iran}{}{ 
\begin{itemize}
...
\item{\cventry{Sep. 2020 to Feb. 2023}{Farzanegan Highschool}{Physics and Calculus Instructor | Part-time}{Shiraz, Iran}{}{ 
\begin{itemize}
...
\vspace{4pt}
\item{\cventry{}{LLVM, Clang, Hugging Face}{\href{https://github.com/maedehdehghanam/LLVM-IR-Optimization-using-Large-Language-Models}{LLVM IR Optimization using Large Language Models}}{}{}{\vspace{3pt} 
\begin{itemize}
...
\vspace{4pt}
\item{\cventry{}{SystemVerilog, ModelSim}{\href{https://github.com/maedehdehghanam/risc-v-Multi-Cycle}{Multi-Cycle RISC-V Processor }}{}{}{\vspace{3pt} 
\begin{itemize}
...
\item The game is developed to run on the DOS operating system, using the DOSBox emulator for compatibility.
\end{itemize}
}}
...
\vspace{4pt}
\item{\cventry{}{Python, Selenium, Pandas, Numpy, scikit-learn}{\href{https://github.com/maedehdehghanam/Laptop-Price-Prediction}{Laptop Price Prediction}}{}{}{\vspace{3pt} 
\begin{itemize}
...
\item \textbf{Hardware Description Languages: }VHDL, SystemVerilog
...
\item \textbf{Tools and Libraries: }Git, Linux, PyTorch, Pandas, Numpy, scikit-learn, LLVM,  Docker, Kubernetes
...
\item{\cventry{}{University of Alberta}{Computer Organization and Architecture I}{Fall 2025}{}{}}


\item{\cventry{}{Shahid Beheshti University}{Operating Systems (x3)}{Spring 2023 -  Spring 2024}{}{}}


\item{\cventry{}{Shahid Beheshti University}{Introduction to Programming (x3) }{Fall 2021 - Spring 2023}{}{}}

\item{\cventry{}{Shahid Beheshti University}{Advanced Programming (x4)}{ Spring 2022 - Spring 2024}{}{}} 
